...
export default async function WorkshopDetailPage({ params }) {
  ...
  return (
    <div className="bg-white min-h-screen">
      ...
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-yellow-50 via-white to-red-50 py-20 lg:py-32 mt-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full text-sm font-semibold bg-yellow-100 text-yellow-800 mb-6">
      ...
      {/* What Kids Will Learn & Weekly Breakdown */}
